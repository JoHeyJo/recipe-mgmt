    ...
    <Combobox as="div" value={selected || ""} onChange={onValueSelect}>
      <div className="relative mt-2">
        ...
        {filteredOptions.length > 0 && (
          <ComboboxOptions className="absolute z-10 mt-1 max-h-30 w-full overflow-auto rounded-md bg-accent py-1 text-base shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm">
